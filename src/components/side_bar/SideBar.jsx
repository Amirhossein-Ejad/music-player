...
export default function SideBar() {
  ...
  return (
    <>
      <div className=" bg-secondary_dark flex-[1_1_0] h-screen">
        {/* logo & image sidebar */}
        <div className="cursor-pointer flex items-center gap-x-2 self-start mx-auto mt-7">
          <img className="w-6 h-6 inline-block" src={logoimg} alt="logoimg" />
          <p className="text-[#ff7400]">RhythmoTune</p>
        </div>
        {/* Menu */}
        <table className="flex flex-col mt-12 gap-y-6 items-center text-white ">
          <tr className="flex gap-x-1 justify-start items-center cursor-pointer hover:bg-[#313237] w-[95%] rounded-2xl px-4 py-2" >

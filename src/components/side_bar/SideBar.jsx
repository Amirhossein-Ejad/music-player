    ...
    <>
      <div className=" flex flex-[1_1_0] h-screen items-center ">
        <div className="w-full h-[94%] bg-secondary_dark rounded-3xl">
          {/* logo & image sidebar */}
          <div className=" justify-center flex items-center gap-x-2 pt-3">
          ...
          <table className="flex flex-col mt-12 gap-y-6 items-center text-white ">
            <tr className="flex gap-x-1 justify-start items-center cursor-pointer hover:bg-[#313237] w-[95%] rounded-2xl px-4 py-3" >

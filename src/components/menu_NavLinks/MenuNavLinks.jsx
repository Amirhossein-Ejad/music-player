...
export default function MenuNavLinks({ onclosePagesMenu }) {
    ...
    return (
        <>
            <NavLink onClick={closeHandler} to={"/"} className={({ isActive, isPending, isTransitioning }) =>
            ...
            <NavLink onClick={closeHandler} to={"/categories"} className={({ isActive, isPending, isTransitioning }) =>
                [isActive ? "active" : "", isPending ? "" : "", isTransitioning ? "" : ""].join(" flex gap-x-1 justify-start items-center cursor-pointer hover:bg-[#313237] w-[95%] rounded-2xl px-4 py-3")}>
            ...
            <NavLink onClick={closeHandler} to={"/artists"} className={({ isActive, isPending, isTransitioning }) =>
                [isActive ? "active" : "", isPending ? "" : "", isTransitioning ? "" : ""].join(" flex gap-x-1 justify-start items-center cursor-pointer hover:bg-[#313237] w-[95%] rounded-2xl px-4 py-3")}>
            ...
            <NavLink onClick={closeHandler} to={"/playlists"} className={({ isActive, isPending, isTransitioning }) =>
                [isActive ? "active" : "", isPending ? "" : "", isTransitioning ? "" : ""].join(" flex gap-x-1 justify-start items-center cursor-pointer hover:bg-[#313237] w-[95%] rounded-2xl px-4 py-3")}>

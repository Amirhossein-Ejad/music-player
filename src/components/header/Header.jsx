    ...
    <div className="flex justify-between items-center w-full h-10 ">
      ...
      <div className="flex justify-evenly items-center gap-x-3">
        ...
        <div className="flex justify-between items-center gap-x-3">
          <div className="flex justify-center items-center rounded-full text-white bg-gray-700 bg-opacity-80 w-10 h-10 object-cover object-center overflow-hidden">
            <svg className=" w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
